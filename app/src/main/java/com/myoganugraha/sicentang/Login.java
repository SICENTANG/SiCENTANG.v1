...
import com.myoganugraha.sicentang.R;
import com.myoganugraha.sicentang.app.AppConfig;
import com.myoganugraha.sicentang.app.AppConfig;
import com.myoganugraha.sicentang.app.AppController;
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    ...
                    Snackbar snackbar = Snackbar.make(linearLayout, "Isi Email dan Password Anda", Snackbar.LENGTH_LONG);
                    snackbar.show();
                }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        // Error in login. Get the error messag
